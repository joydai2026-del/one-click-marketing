...
Two loops share one spine:
    ...
    paid:     generate creative -> evaluate (gate) -> sign approval -> distribute -> collect -> learn

Nothing publishes and nothing spends without a human approval that is cryptographically
bound to the exact content being approved.
